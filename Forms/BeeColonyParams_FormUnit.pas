...
type
  AAaaAaaaaaAaaaaa_Aaaa = class(AAaaa)
    ...
    procedure AaaaaaaAaaaa_aaAaaAaaaaAaaa(Aaaaaa: AAaaaaa; Aaaaa: AAaaaaAaaaa; A, A: Aaaaaaa);
    procedure AaaaaaaAaaaa_aaaAaaAaaaaAaaa(Aaaaaa: AAaaaaa; Aaaaa: AAaaaaAaaaa; A, A: Aaaaaaa);
    procedure AaaAaaaAaaa_aaaAaaAaaaaAaaa(Aaaaaa: AAaaaaa; Aaaaa: AAaaaaAaaaa; A, A: Aaaaaaa);
...
var
  AaaAaaaaaAaaaaa_Aaaa: AAaaAaaaaaAaaaaa_Aaaa;

implementation

{$A *.aaa}

procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaAaaaaaaAaaaa(Aaaaaa: AAaaaaa);
var a: Aaaaaaa;
begin
  if not AaaAaaAaAaa((Aaaaaa as AAaaaAaaa).Aaaa, a) then (Aaaaaa as AAaaaAaaa).Aaaaa := (Aaaaaa as AAaaaAaaa).AaaAaaaa;
end;

procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaaAaaaaaaaaaaAaaa_aaaAaaAaaa(Aaaaaa: AAaaaaa);
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaaAaaaaaaaaaaAaaa_aaAaaAaAaaaa(Aaaaaa: AAaaaaa);
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaaaAaaaa_aaAaaAaaaAaaaa(Aaaaaa: AAaaaaa);
var aaaAaa: AAaaaaaaAaaa;
begin
  aaaAaa := (Aaaaaa as AAaaaAaaaaa).AaaaaAaaaaaa as AAaaaaaaAaaa;
  aaaAaa.aaAaaa(aaaAaa);
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaAaaaaaaaaa(Aaaaaa: AAaaaaa);
var a: Aaaaaaa;
begin
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaaaAaaaa_aaaAaaAaaAaaaa(Aaaaaa: AAaaaaa; var Aaa: Aaaa);
var aaaAaa: AAaaaaaaAaaa;
begin
  aaaAaa := Aaaaaa as AAaaaaaaAaaa; 
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaAaaaa_aaAaaAaaa(Aaaaaa: AAaaaaa);
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaAaaaa_aaAaaAaaAaaaa(Aaaaaa: AAaaaaa; var Aaa: Aaaa);
begin     
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaaaAaaaa_aaaAaaAaaAaaa(Aaaaaa: AAaaaaa; var Aaa: Aaaa; Aaaaa: AAaaaaAaaaa);
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaAaaaaa(Aaaaaa: AAaaaaa);
var a: Aaaa;
begin
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaaaAaaaa_aaAaaAaaaaAaaa(Aaaaaa: AAaaaaa; Aaaaa: AAaaaaAaaaa; A, A: Aaaaaaa);
var a, a: Aaaaaaa;
begin
  a := ?; a := ?;
  AaaaaaaAaaaa_aaAaa.Aaaa := 'Aa aaaaaaa aaa aaaaaaa aaaaaa, aaa aaaaaaaaaaa: ';
  if not AaaAaaAaAaa(AaaaAaaaa_aaAaa.Aaaa,a) then a := AaaaAaaaa_aaAaa.AaaAaaaa;
  if not AaaAaaAaAaa(AaaaaaaAaaaa_aaAaa.Aaaa,a) then a := AaaaaaaAaaaa_aaAaa.AaaAaaaa
  else a := Aaaaa(a/(a+?));
  if a = ? then Aaa(a);
  AaaaaaaAaaaa_aaAaa.Aaaa := AaaaaaaAaaaa_aaAaa.Aaaa + AaaAaAaa(a) + '/' + AaaAaAaa(a - a);
end;

procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaaaaAaaaa_aaaAaaAaaaaAaaa(Aaaaaa: AAaaaaa; Aaaaa: AAaaaaAaaaa; A, A: Aaaaaaa);
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaAaaaAaaa_aaaAaaAaaaaAaaa(Aaaaaa: AAaaaaa; Aaaaa: AAaaaaAaaaa; A, A: Aaaaaaa);
var a: Aaaaaaaa; a, a: Aaaaaaa;
begin
  a := ?; a := ?; a := ?;
  AaaAaaaAaaa_aaaAaa.Aaaa := 'Aaaaaaaaaa aaaaaaaaaa aaaaaaa.'#??#??'Aaaaaaaaaaaa aaaaaaa aaaaa, aaaaaaa aaaaa a aaaaaaaaa [?;?].'#??#??'Aaaaa aaaaaaaaaa aaaaaaa aaaaa: Aaa-aa aaaaaaa aaaaaaaaaaa * Aaaaaaaa = ';
  if not AaaAaaAaAaa(AaaaAaaaa_aaAaa.Aaaa,a) then a := AaaaAaaaa_aaAaa.AaaAaaaa; 
  if not AaaAaaAaAaa(AaaaaaaAaaaa_aaAaa.Aaaa,a) then a := AaaaaaaAaaaa_aaAaa.AaaAaaaa
  else a := Aaaaa(a/(a+?));
  if a = ? then Aaa(a);
  if not AaaAaaAaAaaaa(AaaAaaaAaaa_aaaAaa.Aaaa,a) or (a*a <= ?.?) then AaaAaaaAaaa_aaaAaa.Aaaa := AaaAaaaAaaa_aaaAaa.Aaaa + '?'
  else AaaAaaaAaaa_aaaAaa.Aaaa := AaaAaaaAaaa_aaaAaa.Aaaa + AaaaaaaAaaaaaaaa(Aaaaa(a * a));
end;

procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaAaaa(Aaaaaa: AAaaaaa);
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaAaaaaaaa(Aaaaaa: AAaaaaa);
begin
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaAaaa(var Aaaaaaa: AAaaaaaa); //aaaaaaaaaa "aaaaaaa aaaaaa"
begin
...
procedure AAaaAaaaaaAaaaaa_Aaaa.AaaaAaaaa_aaAaaAaaaa(Aaaaaa: AAaaaaa);
